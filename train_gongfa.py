...
def main():
    ...
    images = np.load('imgs_three_datasets_two_channels.npy')
    masks = np.load('image_mask_true_three_datasets.npy')
    train_leave_one_out(images, masks, patient=0, full=False, verbose=True)
